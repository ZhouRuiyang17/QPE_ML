...
for i in range(5):
    ...
    df1.to_csv(path+str(limi[i])+'-'+str(limi[i+1])+'_event.csv')
...
plt.boxplot([(y_pred - y_test),(zr_mayu - y_test),(zr_300 - y_test),(zr_200 - y_test)], 
            labels = ['$QPE_{FC}$', '$Z=238R^{1.57}$', '$Z=300R^{1.4}$', '$Z=200R^{1.6}$'],
